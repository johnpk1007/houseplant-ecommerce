...
export default function AuthInput(
    { name, type, placeholder, onChange, value, error, touched = true, onBlur }
        :
        { name: string, type: string, placeholder: string, onChange: (e: ChangeEvent<HTMLInputElement, Element>) => void, value: string, error: string, touched?: boolean, onBlur?: (e: FocusEvent<HTMLInputElement, Element>) => void }) {
