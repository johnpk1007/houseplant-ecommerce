...
export default function MinusButton({ cartItemId, quantity, stage }: { cartItemId: number, quantity: number, stage: number }) {
    ...
    const handleMinus = async ({ cartItemId, quantity }: { cartItemId: number, quantity: number }) => {
        ...
        try {
            ...
            errorToast('Edit cart item failed')
        }
        setIsLoading(false)
    }
    const handleDelete = async ({ }) => {
        ...
        try {
            ...
            errorToast('Delete cart item failed')
        }
        setIsLoading(false)
    }
